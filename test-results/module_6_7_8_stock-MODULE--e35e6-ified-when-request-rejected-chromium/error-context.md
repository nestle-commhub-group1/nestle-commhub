...
- Name: module_6_7_8_stock.spec.js >> MODULE 6, 7, 8: Stock Requests >> TC-46: Retailer notified when request rejected
- Location: tests/e2e/module_6_7_8_stock.spec.js:189:3
...
Locator: locator('text=has been rejected').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=has been rejected').first()
    ...
    - generic [ref=e223]:
      ...
      - generic [ref=e232] [cursor=pointer]:
        ...
        - generic [ref=e237]:
          ...
          - paragraph [ref=e239]: 43 seconds ago
