...
- Name: module_6_7_8_stock.spec.js >> MODULE 6, 7, 8: Stock Requests >> TC-35: Staff notified when new stock request submitted
- Location: tests/e2e/module_6_7_8_stock.spec.js:82:3
...
Call log:
  - waiting for locator('.hidden.lg\\:flex button')
...
```ts
  ...
  2   | const { LoginPage, StockRequestsPage } = require('./pages/AppPages');
  3   | 
  4   | test.describe('MODULE 6, 7, 8: Stock Requests', () => {
  5   | 
  6   |   // MODULE 6: Submit Stock Requests
  7   |   test('TC-29: Retailer submits stock request with valid details', async ({ page }) => {
